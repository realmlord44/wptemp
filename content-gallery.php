	...
	<div class="entry-content">
		<?php if ( post_password_required() ) : ?>
			...
			<?php else :
				...
				<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'babystore' ),
						'href="' . get_permalink() . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'babystore' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark"',
